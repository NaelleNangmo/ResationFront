...
Future<void> _loadData() async {
  try {
    await context.read<ReservationProvider>().loadAllReservations();
  } catch (e) {
        ...
        builder: (context, provider, _) {
          return LoadingOverlay(
            ...
            child: TabBarView(
              controller: _tabController,
              children: [
                _buildReservationsList(provider.allReservations),
                _buildReservationsList(provider.getReservationsByStatus('active', isAdmin: true)),
                _buildReservationsList(provider.getTodayReservations(isAdmin: true)),
                _buildReservationsList(provider.getReservationsByStatus('annulee', isAdmin: true)),
              ],
            ),
          );
        },
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    reservation.utilisateurNom ?? 'Utilisateur inconnu',
            ...
            // Email
            if (reservation.utilisateurEmail != null) ...[
              Row(
                children: [
                  Icon(
                    Icons.email,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Utilisateur: ${reservation.utilisateurNom}'),
